...
require 'fastlane/plugin/get_version_from_json/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-get_version_from_json'
  spec.version       = Fastlane::GetVersionFromJson::VERSION
  ...
  spec.add_development_dependency('fastlane', '>= 2.152.0')
end
